...
MEIRO.Models.M03061 = function M03061(room, model)
{
	...
	this.image.add(this.coordSys,this.point,this.plates,this.contours,this.labelP,this.labelX,this.labelY,this.labelZ);
}
...
{	
	...
	this.contours.position.copy(this.plates.position);
	this.contours.scale.copy(this.plates.scale);
