...
struct Config{
    ...
    struct World {
        inline static constexpr float WAIT_SECONDS_BEFORE_NEXT_STEP = 0.00001;
    ...
    struct Debug{
        ...
        inline static constexpr bool DUAL_BUFFER = false;
    };

    struct Spawn {
        inline static constexpr float INITIAL_FISH_DENSITY = 0.3f;
